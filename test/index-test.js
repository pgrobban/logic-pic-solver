...
describe('try find direct solution for row', () => {
  ...
  it('Test case 6', () => {
    const input = ['X', 'X', 'O', 'O', 'X', 'O', undefined];
    const expectedResult = ['X', 'X', 'O', 'O', 'X', 'O', 'O'];
    const rowHint = [2, 2];
    const actualResult = tryFindDirectSolutionForRowOrColumn(rowHint, input);
    should.deepEqual(expectedResult, actualResult);
  });
  ...
  it('Test case 7', () => {
    const input = ['O', 'X', 'X', 'X', 'X', 'X', undefined];
    const expectedResult = ['O', 'X', 'X', 'X', 'X', 'X', 'O'];
    const rowHint = [1, 1];
    const actualResult = tryFindDirectSolutionForRowOrColumn(rowHint, input);
    should.deepEqual(expectedResult, actualResult);
  });

  it('Test case 8 should leave input untouched', () => {
    const input = [undefined, undefined, 'X', 'X', undefined];
    const expectedResult = [undefined, undefined, 'X', 'X', undefined];
    const rowHint = [1];
    const actualResult = tryFindDirectSolutionForRowOrColumn(rowHint, input);
    should.deepEqual(expectedResult, actualResult);
  });
  ...
  it('Test case 9', () => {
    const input = ['O', 'O', 'X', 'X', 'X', 'X', 'O', undefined, 'X', 'X'];
    const expectedResult = ['O', 'O', 'X', 'X', 'X', 'X', 'O', 'O', 'X', 'X'];
    const rowHint = [2, 2];
    const actualResult = tryFindDirectSolutionForRowOrColumn(rowHint, input);
    should.deepEqual(expectedResult, actualResult);
  });

  it('Test case 9 should leave input untouched', () => {
    const input = [undefined, undefined, undefined, undefined, undefined];
    const expectedResult = [undefined, undefined, undefined, undefined, undefined];
    const rowHint = [3];
    const actualResult = tryFindDirectSolutionForRowOrColumn(rowHint, input);
    should.deepEqual(expectedResult, actualResult);
  });

  it('Test case 10 should leave input untouched', () => {
    const input = [undefined, 'O', 'O', undefined, undefined];
    const expectedResult = [undefined, 'O', 'O', undefined, undefined];
    const rowHint = [3];
    const actualResult = tryFindDirectSolutionForRowOrColumn(rowHint, input);
    should.deepEqual(expectedResult, actualResult);
  });
  ...
  it('Test case 11', () => {
    const input = ['X', undefined, 'X', undefined, 'O'];
    const expectedResult = ['X', undefined, 'X', 'O', 'O'];
    const rowHint = [2];
    const actualResult = tryFindDirectSolutionForRowOrColumn(rowHint, input);
    should.deepEqual(expectedResult, actualResult);
  });
  ...
  it('Test case 12', () => {
    const input = ['O', 'O', 'X', undefined, undefined, 'X', undefined, 'X', 'O', 'O'];
    const expectedResult = ['O', 'O', 'X', undefined, undefined, 'X', 'O', 'X', 'O', 'O'];
    const rowHint = [2, 1, 1, 2];
    const actualResult = tryFindDirectSolutionForRowOrColumn(rowHint, input);
    should.deepEqual(expectedResult, actualResult);
  });

  it('Test case 13 should leave input untouched', () => {
    const input = ['X', 'O', 'X', undefined, undefined, undefined, 'X'];
    const expectedResult = ['X', 'O', 'X', undefined, undefined, undefined, 'X'];
    const rowHint = [1, 2];
    const actualResult = tryFindDirectSolutionForRowOrColumn(rowHint, input);
    should.deepEqual(expectedResult, actualResult);
  });
  ...
  it('Test case 14', () => {
    const input = ['X', 'O', 'X', undefined, undefined, 'O', 'X'];
    const expectedResult = ['X', 'O', 'X', undefined, 'O', 'O', 'X'];
    const rowHint = [1, 2];
    const actualResult = tryFindDirectSolutionForRowOrColumn(rowHint, input);
    should.deepEqual(expectedResult, actualResult);
  });
  ...
  /* it('Test case 15', () => {
    const input = [undefined, 'O', undefined, 'O', undefined, undefined, 'O'];
    const expectedResult = [undefined, 'O', undefined, 'O', undefined, undefined, 'O']
    const rowHint = [2, 1, 1];
    const actualResult = tryFindDirectSolutionForRowOrColumn(rowHint, input);
    should.deepEqual(expectedResult, actualResult);
  }); */
...
describe('Try find sequential solution for row or column', () => {
  ...
  it('test case 3', () => {
    const input = [undefined, 'X', 'X', undefined, undefined];
    const expectedResult = [undefined, 'X', 'X', undefined, undefined];
    const rowHint = [2];
    const actualResult = tryFindSequentialSolutionForRowOrColumn(rowHint, input);
    should.deepEqual(expectedResult, actualResult);
  });

  it('Test case 4 should leave input untouched', () => {
    const input = [ 'X', 'O', 'X', undefined, undefined, undefined, undefined ];
    const expectedResult = [ 'X', 'O', 'X', undefined, undefined, undefined, undefined ];
    const rowHint = [1, 1];
    const actualResult = tryFindSequentialSolutionForRowOrColumn(rowHint, input);
    should.deepEqual(expectedResult, actualResult);
  });
  ...
  /* it('test case 4', () => {
    const input = ['O', 'O', 'X', 'O', undefined, undefined, 'X'];
    const expectedResult = [undefined, 'X', 'X', undefined, undefined];
    const rowHint = [2];
    const actualResult = tryFindSequentialSolutionForRowOrColumn(rowHint, input);
    should.deepEqual(expectedResult, actualResult);
...
describe('Fill in impossible moves for row or column', () => {
  ...
  it('Test case 7 should leave input untouched', () => {
    const input = [undefined, 'X', undefined, undefined, undefined];
    const expectedResult = [undefined, 'X', undefined, undefined, undefined];
    const rowHint = [3];
    const actualResult = fillImpossibleMovesForRowOrColumn(rowHint, input);
    should.deepEqual(expectedResult, actualResult);
  });
  ...
  it('Test case 8', () => {
    const input = ['O', 'O', undefined, 'O', undefined, undefined, 'X'];
    const expectedResult = ['O', 'O', 'X', 'O', 'X', undefined, 'X'];
    const rowHint = [2, 1, 1];
    const actualResult = fillImpossibleMovesForRowOrColumn(rowHint, input);
    should.deepEqual(expectedResult, actualResult);
  });
  ...
  it('Test case 9 should leave input untouched', () => {
    const input = ['X', 'O', 'X', undefined, undefined, 'O', 'X'];
    const expectedResult = ['X', 'O', 'X', undefined, undefined, 'O', 'X'];
    const rowHint = [1, 2];
    const actualResult = fillImpossibleMovesForRowOrColumn(rowHint, input);
    should.deepEqual(expectedResult, actualResult);
  });
  ...
  it('Test case 13 should leave input untouched', () => {
    const input =  [undefined, undefined, undefined, 'O', undefined, undefined, 'X' ];
    const expectedResult =  [ undefined, undefined, undefined, 'O', undefined, undefined, 'X' ];
    const rowHint = [1, 2];
    const actualResult = fillImpossibleMovesForRowOrColumn(rowHint, input);
    should.deepEqual(expectedResult, actualResult);
...
describe('Solver', () => {
  ...
  it('Should solve First steps 2', () => {
    ...
    const actualSolution = solve(LEVELS.FIRST_STEPS.find(level => level.name === '2'));
    should.deepEqual(expectedSolution, actualSolution);
  });
  ...
  it('Should solve First steps 12', () => {
    ...
    const actualSolution = solve(LEVELS.FIRST_STEPS.find(level => level.name === '12'));
    should.deepEqual(expectedSolution, actualSolution);
  });
